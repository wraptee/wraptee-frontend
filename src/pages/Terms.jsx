...
const TermsAndPolicy = () => {
  return (
    <Container sx={{ mt: 5, backgroundColor: " #f9f9f9" }}>
      <Typography
        variant="h4"
        gutterBottom
        className="title"
      ...
      <Typography className="title" textAlign={"center"}>
        Last updated September Jan, 2025 <br></br> TABLE OF CONTENTS <br></br>
      </Typography>
      <Typography className="title" mb={5}>
        <ul>
          ...
          <li>8. GUIDELINES FOR REVIEWS</li>
          <li>9. SOCIAL MEDIA</li>
          <li>10. SUBMISSIONS</li>
          <li>11. ADVERTISERS</li>
          <li>12. SITE MANAGEMENT</li>
          ...
          <li>22. USER DATA</li>
          <li>23. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</li>
        ...
        (“you”) and Anshil Wellness ("Company," “we," “us," or “our”),
        concerning your access to and use of the https://anshilwellness.com/
        ...
        registered office at Kalka ji Extention, New Delhi, Delhi 110019. You
        ...
        Terms of Use at any time and for any reason. We will alert you about any
        ...
        for the Site. 2. INTELLECTUAL PROPERTY RIGHTS Unless otherwise
        ...
        rights and unfair competition laws of the United States, international
        copyright laws, and international conventions. The Content and the Marks
        ...
        and the Marks. 3. USER REPRESENTATIONS By using the Site, you represent
        ...
        information as necessary; (3) you have the legal capacity and you agree
        ...
        purpose; and (7) your use of the Site will not violate any applicable
        ...
        the Site (or any portion thereof). 4. USER REGISTRATION You may be
        ...
        is inappropriate, obscene, or otherwise objectionable. 5. PROHIBITED
        ACTIVITIES You may not access or use the Site for any purpose other than
        ...
        advertise or offer to sell goods and services. 6. USER GENERATED
        CONTRIBUTIONS The Site does not offer users to submit or post content.
        ...
        to use the Site. 7. CONTRIBUTION LICENSE You agree that we may access,
        ...
        us regarding your Contributions. 8. GUIDELINES FOR REVIEWS We may
        provide you areas on the Site to leave reviews or ratings. When posting
        a review, you must comply with the following criteria: (1) you should
        ...
        perform, and/or distribute all content relating to reviews. 9. SOCIAL
        MEDIA As part of the functionality of the Site, you may link your
        ...
        profile picture that become associated with your account. 10.
        ...
        misappropriation of any proprietary right in your Submissions. 11.
        ADVERTISERS We allow advertisers to display their advertisements and
        other information in certain areas of the Site, such as sidebar
        ...
        relationship with advertisers. 12. SITE MANAGEMENT We reserve the right,
        but not the obligation, to: (1) monitor the Site for violations of these
        Terms of Use; (2) take appropriate legal action against anyone who, in
        ...
        of the Site. 13. PRIVACY POLICY We care about data privacy and security.
        Please review our Privacy Policy:
        https://anshilwellness.com/privacypolicy. By using the Site, you agree
        to be bound by our Privacy Policy, which is incorporated into these
        Terms of Use. Please be advised the Site is hosted in India. If you
        ...
        the Site, you are transferring your data to India, and you agree to have
        your data transferred to and processed in India. 14. TERM AND
        TERMINATION These Terms of Use shall remain in full force and effect
        ...
        criminal, and injunctive redress. 15. MODIFICATIONS AND INTERRUPTIONS We
        ...
        suspend, discontinue, or otherwise modify the Site at any time or for
        ...
        any corrections, updates, or releases in connection therewith. 16.
        GOVERNING LAW These Terms shall be governed by and defined following the
        laws of India. Anshil Wellness and yourself irrevocably consent that the
        courts of India shall have exclusive jurisdiction to resolve any dispute
        which may arise in connection with these terms. 17. DISPUTE RESOLUTION
        ...
        __________. Restrictions The Parties agree that any arbitration shall be
        ...
        Parties agree to submit to the personal jurisdiction of that court. 18.
        ...
        prior notice. 19. DISCLAIMER THE SITE IS PROVIDED ON AN AS-IS AND
        ...
        USE YOUR BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE. 20.
        ...
        OF THE POSSIBILITY OF SUCH DAMAGES. 21. INDEMNIFICATION You agree to
        ...
        indemnification upon becoming aware of it. 22. USER DATA We will
        maintain certain data that you transmit to the Site for the purpose of
        managing the performance of the Site, as well as data relating to your
        ...
        from any such loss or corruption of such data. 23. ELECTRONIC
        COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES Visiting the Site, sending
        ...
        credits by any means other than electronic means. 24. MISCELLANEOUS
        ...
        the parties hereto to execute these Terms of Use. 25. CONTACT US In
        order to resolve a complaint regarding the Site or to receive further
        information regarding use of the Site, please contact us at: Anshil
        Wellness Kalka ji Extention New Delhi, Delhi 110019 India Phone:
        7982246419 careanshil@gmail.com
      </Typography>
    </Container>
  );
};
